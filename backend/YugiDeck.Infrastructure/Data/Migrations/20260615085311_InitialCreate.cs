        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Player1LP = table.Column<int>(type: "INTEGER", nullable: false),
                    Player2LP = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LPLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LPLogs_Duels_DuelId",
                        column: x => x.DuelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeckCards_DeckId_CardId_Section",
                table: "DeckCards",
                columns: new[] { "DeckId", "CardId", "Section" });

            migrationBuilder.CreateIndex(
                name: "IX_LPLogs_DuelId",
                table: "LPLogs",
                column: "DuelId");
